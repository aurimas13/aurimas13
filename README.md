...
<p align="left">   
 ...
 <!--  <img height="25px" title="github followers" src="https://img.shields.io/github/followers/aurimas13?style=social" alt="followers" title ="followers"> -->
  <!-- <a href="https://twitter.com/reksas13" target="blank"><img height="25px" src="https://img.shields.io/twitter/follow/reksas13?label=follow Aurimas&style=social" alt="reksas13" /></a> -->
</p> 
...
fields_of_interests: ["Management", "Product Delivery", "Artificial Intelligence", "Artificial General Intelligence", "Chemistry", "Mental Health", "Robot-AI Interaction", "LLM", "Computer Science", "Data Engineering", "Machine Learning"]
technical_background: ["Python", "Java", "Machine Learning", "SQL", "Flask", "JavaScript", "Terraform", "Spark", "Databricks", "Azure", "AWS", "GCP"]
currently_learning: ["Strategy, Management, Delivery, Optimization"]
hobbies: ["Public Speaking", "Writing", "Reading", "Walking", "Running", "Basketball", "Formula 1"]
```
 
Throughout my professional journey, I've been fortunate to work across diverse domains, including teaching Python, developing AI and ML applications/algorithms, and building data engineering solutions. As a lifelong learner, I stay up to date with the latest technological advancements and strive to solve complex problems using my ever-expanding toolbox, which includes Python, Java, Machine Learning, SQL, Flask, JavaScript, Terraform, Spark, Azure, and AWS, to name a few.

I actively contributed to several projects like [Machine-Learning-Goodness](https://github.com/aurimas13/Machine-Learning-Goodness), [AI Course](https://github.com/aurimas13/CodeAcademy-AI-Course), [Python Course](https://github.com/aurimas13/Python-Beginner-Course), and daily problems solved at [Solutions-To-Problems](https://github.com/aurimas13/Solutions-To-Problems). I believe in learning by doing, and my hands-on experience with many projects is a testament to my passion for technology.

Apart from my technical expertise, I'm also an avid reader, writer, and public speaker, and a member of several computing, voluntary, and philanthropic organisations.

Feel free to explore my work, <!-- connect with me on [LinkedIn](https://www.linkedin.com/in/aurimasnausedas/), or --> inspect me on [my personal website](https://www.aurimas.io) or through my [X account](https://twitter.com/reksas13) for exciting updates and conversations. I'm always open to collaborations and opportunities to work on exciting projects that need an AI or Technical lead!

Let's build a future where technology and innovation drive the world towards greater heights. 🚀

<!-- - ⚡ Check out my additional profile [here](https://www.linkedin.com/in/aurimasnausedas/) to find **a short introduction story**. -->
...
- 👯 I'm open to collaboration opportunities that need a guidance through lead with fellow developers or AI/ML engineers to assist through my **Machine Learning** skills, work on **AI** or **AGI** projects, **Flask** or more **SQL**, create **Java** and **Python-based** technologies by broadening your and my **Development** arsenal, and other invitations to utilize **Java** and **Python**.
- 🌱 In summary: I am an AI/Technical Product Lead who is very proficient in **Python**, **Java**, **Machine Learning**, **MLOps**, **LLMOps**, **LLMs**, **AI**, and further expanding my *knowledge* in Management, Delivery, Optimization and Strategy.
...
<p align="left">
<a href="https://twitter.com/reksas13">
  <img alt="reksas13 | Twitter" width="50px" src="https://user-images.githubusercontent.com/43545812/144034996-602b144a-16e1-41cc-99e7-c6040b20dcaf.png"/>
</a>
...
<a href="https://www.instagram.com/reksas13/">
  <img alt="reksas13's Instagram" width="50px" src="https://user-images.githubusercontent.com/43545812/144035088-0dfb165f-8fe0-4d13-896c-876c29d2b128.png" />
</a>
