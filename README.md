...
- 💬 Ask me about **Python** as its proficiency builds on the [*Complete Python Developer*](https://www.udemy.com/certificate/UC-c3951e1b-dd47-4c1c-9d3f-f153744dd337/) course, finishing *Learn Python The Hard Way* [*Learn Python The Hard Way*](https://github.com/aurimas13/Python-solutions) online book, having recently done [Calculator](https://github.com/aurimas13/Calculator-program) and [Web Scraper](https://github.com/aurimas13/Web-Scraper) programs as well as on having worked with **Python** since 2013. 
